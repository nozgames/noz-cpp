...
namespace noz {
    ...
    float lua::GetNumberField(lua_State* L, int index, const char* field_name, float default_value) {
    ...
    Align lua::GetAlignField(lua_State* L, int index, const char* field_name, Align default_value) {
        lua_getfield(L, index, field_name);
    ...
    Color lua::GetColorField(lua_State* L, int index, const char* field_name, const Color& default_value) {
        lua_getfield(L, index, field_name);
    ...
    u8 lua::GetU8Field(lua_State* L, int index, const char* field_name, u8 default_value) {
        lua_getfield(L, index, field_name);
    ...
    i32 lua::GetIntField(lua_State* L, int index, const char* field_name, int default_value) {
        lua_getfield(L, index, field_name);
    ...
    Asset* lua::GetAssetField(lua_State* L, int index, const char* field_name, Asset* default_value) {
        lua_getfield(L, index, field_name);
