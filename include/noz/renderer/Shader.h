...
namespace noz::renderer
{
    ...
    private:
        ...
        int _vertexUniformBufferCount;
        int _fragmentUniformBufferCount;
        int _samplerCount;        
		Flags _flags;
    ...
    inline int Shader::vertexUniformBufferCount() const { return _vertexUniformBufferCount; }
    inline int Shader::fragmentUniformBufferCount() const { return _fragmentUniformBufferCount; }
    inline int Shader::samplerCount() const { return _samplerCount; }

    inline bool Shader::depthTest() const
    {
        return (static_cast<uint16_t>(_flags) & static_cast<uint16_t>(Flags::DepthTest)) == static_cast<uint16_t>(Flags::DepthTest);
    }

    inline bool Shader::depthWrite() const
    {
        return (static_cast<uint16_t>(_flags) & static_cast<uint16_t>(Flags::DepthWrite)) == static_cast<uint16_t>(Flags::DepthWrite);
    }

    inline bool Shader::blendEnabled() const
    {
        return (static_cast<uint16_t>(_flags) & static_cast<uint16_t>(Flags::Blend)) == static_cast<uint16_t>(Flags::Blend);
    }
