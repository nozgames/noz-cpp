...
namespace noz::editor {
    ...
    static void UpdateRotate() {
        ...
        Vec2 start_dir = g_workspace.drag_world_position - center;
        Vec2 current_dir = g_workspace.mouse_world_position - center;
    ...
    static void DrawRotate() {
        ...
        const Vec2& center = g_rotate.options.origin;
        const Vec2 dir = Normalize(g_workspace.drag_world_position - center);
        ...
        DrawDashedLine(center, g_workspace.mouse_world_position);
        ...
        DrawVertex(g_workspace.mouse_world_position, ROTATE_TOOL_CENTER_SIZE);
    }
